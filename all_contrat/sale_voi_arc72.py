...
def approval_program():
    ...
    program = Cond(
        ...
        [Txn.on_completion() == OnComplete.DeleteApplication, on_delete("sale,close,1/72")],
        [And(Txn.on_completion() == OnComplete.NoOp, Txn.application_args[0] == Bytes("fund")), on_fund("sale,fund,1/72")],
